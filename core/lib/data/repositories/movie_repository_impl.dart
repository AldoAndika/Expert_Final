...
class RepositoryImplMovie implements RepositoryMovie {
  ...
  @override
  Future<Either<Failure, DetailMovie>> getMovieDetail(int id) async {
    try {
  ...
  @override
  Future<Either<Failure, String>> saveWatchlist(DetailMovie movie) async {
    try {
      final result =
  ...
  @override
  Future<Either<Failure, String>> removeWatchlist(DetailMovie movie) async {
    try {
      final result =
