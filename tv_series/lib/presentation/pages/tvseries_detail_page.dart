...
import '../bloc/detail_tvseries/bloc.dart';
import '../bloc/tvseries_recommendations/bloc.dart';

class TvSeriesDetailPage extends StatefulWidget {
  static const routeName = '/watchlist-tvseries-detail';
  final int id;
...
class _TvSeriesDetailPageState extends State<TvSeriesDetailPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<DetailBlocTv>().add(OnTvseriesDetailCalled(widget.id));
      context
          .read<TvRecommendationsBloc>()
          .add(OnTvseriesRecommendationsCalled(widget.id));
      context
          .read<WatchlistBlocTv>()
  ...
  Widget build(BuildContext context) {
    final isTvseriesAddedToWatchlist =
        context.select<WatchlistBlocTv, bool>((bloc) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<DetailBlocTv, TvseriesDetailState>(
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!widget.isAddedWatchlist) {
                                  context.read<WatchlistBlocTv>().add(
                                ...
                                final state =
                                    BlocProvider.of<WatchlistBlocTv>(
                                            context)
                                        .state;
