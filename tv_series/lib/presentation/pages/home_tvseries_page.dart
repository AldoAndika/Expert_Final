...
class _HomeTvSeriesPageState extends State<HomeTvSeriesPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<OnTheAirBloc>().add(OnTheAirTvseries());
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<OnTheAirBloc, OnTheAirTvseriesState>(
              ...
              BlocBuilder<PopularBlocTv, PopularTvseriesState>(
                  builder: (context, state) {
              ...
              BlocBuilder<TopRatedBlocTv, TopRatedTvseriesState>(
                  builder: (context, state) {
