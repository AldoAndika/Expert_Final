...
void main() {
  ...
  late TvRecommendationsBloc tvseriesRecommendationsBloc;
  ...
  setUp(() {
    ...
    tvseriesRecommendationsBloc =
        TvRecommendationsBloc(mockGetTvseriesRecommendations);
  });
  ...
  blocTest<TvRecommendationsBloc, TvseriesRecommendationsState>(
