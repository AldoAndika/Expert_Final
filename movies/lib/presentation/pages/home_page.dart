...
class _HomeMoviePageState extends State<HomeMoviePage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      BlocProvider.of<TopRatedBlocMovie>(context, listen: false)
          .add(OnTopRatedMoviesCalled());
      BlocProvider.of<PopularBlocMovie>(context, listen: false)
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<PopularBlocMovie, PopularMoviesState>(
                builder: (context, state) {
              if (state is NowPlayingMovieLoading) {
                return const Center(
                  child: CircularProgressIndicator(),
            ...
            BlocBuilder<TopRatedBlocMovie, TopRatedMoviesState>(
                builder: (context, state) {
