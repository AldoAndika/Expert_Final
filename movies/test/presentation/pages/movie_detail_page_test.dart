...
void main() {
  ...
  Widget _makeTestableWidget(Widget body) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<DetailBlocMovie>(
          create: (_) => fakeMovieDetailBloc,
        ),
        BlocProvider<WatchlistBlocMovies>(
  ...
  testWidgets('page should display circular progress indicator when loading',
    ...
    await tester.pumpWidget(_makeTestableWidget(const DetailPageMovie(
      id: testId,
    )));
    await tester.pump();
  ...
  testWidgets('should widget display which all required',
    ...
    await tester
        .pumpWidget(_makeTestableWidget(const DetailPageMovie(id: testId)));
    await tester.pump();
